...
const Button = ({onClick , text}:BTNProps) => {
  return (
    <button
            onClick={onClick}
            className="bg-gray-950 text-gray-400 border mt-5 border-gray-400 border-b-4 font-medium overflow-hidden relative px-4 py-2 rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group"
          >
