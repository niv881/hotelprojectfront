...
const ToggleToDarkMode = ({onClick}:BTNProps) => {
  return (
    <label className="relative w-10 block aspect-[2/0.75] cursor-pointer  rounded-full  bg-gradient-to-r from-white to-black bg-[length:100%_100%] shadow-2xl shadow-purple-300 transition-all duration-500 [&amp;:has(input:checked)]:rotate-180  hover:bg-[length:100%_500%] focus:bg-[length:100%_500%]">
    <input
      onClick={() => {
        onClick()
      }}
